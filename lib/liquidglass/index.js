/*!
 * Vendored from @ybouane/liquidglass v1.0.3 (MIT License).
 * Source: https://github.com/ybouane/liquidglass
 * Prebuilt ESM bundle (dist/index.js) — includes its patched html-to-image inline.
 * Vendored to avoid a runtime CDN dependency; loaded only on capable desktop clients.
 */
// src/defaults.ts
var DEFAULTS = {
  blurAmount: 0,
